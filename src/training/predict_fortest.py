...
if not os.path.exists('data/mask_tiles_fortest_predicted'):
        os.makedirs('data/mask_tiles_fortest_predicted')
...
def main():    
    outPath ='data/mask_tiles_fortest_predicted'
    path = 'data/image_tiles_fortest'
    i=0
